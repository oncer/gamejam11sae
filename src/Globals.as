...
package
{
	...
	{
		public static const MAX_VISITORS:uint = 1024; // group capacity
		public static const MAX_SPITS:uint = 100; // group capacity
		public static const MAX_FLYERS:uint = 100; // group capacity, max. # of collision checked flying visitors
